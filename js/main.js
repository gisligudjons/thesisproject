...
var icelandWrapper = document.querySelector('.icelandWrapper img')
...
d3.select("#step-one").on('stepin', function(e) {
  ...
  function erase() {
    ...
    document.getElementById("icelandWrapperImg").style.opacity="0"
...
d3.select("#step-five").on('stepin', function(e) {
  ...
  function draw() {
    document.getElementById("icelandWrapperImg").style.opacity="1"
  }
  setTimeout(draw, 800)
